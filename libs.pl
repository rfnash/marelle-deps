...
installs_with_apt('libglib2.0-doc', 'libglib2.0-doc').
debian_pkg('libgmime-2.6-dev').
installs_with_apt('libgmime-2.6-dev', 'libgmime-2.6-dev').
...
installs_with_apt('liblwp-protocol-socks-perl', 'liblwp-protocol-socks-perl').
...
installs_with_apt('libnpth0-dev', 'libnpth0-dev').
...
installs_with_apt('libxcb-util0-dev', 'libxcb-util0-dev').
